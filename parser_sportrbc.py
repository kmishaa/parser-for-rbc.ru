...
def get_text(link): #получение текста статьи
    ...
    text = ''
    all_p = soup.find('div', class_='article__text article__text_free').find_all('p') #получение всех абзацев
    for p in all_p: 
...
def parse():
    dates = ['09.02.2018', '25.02.2018', '09.05.2018', '25.05.2018', '23.07.2021', '08.08.2021', '23.10.2021', '08.11.2021'] #все исследуемые даты
    prints = { #выводы
